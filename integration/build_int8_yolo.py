...
class EngineCalibrator(trt.IInt8EntropyCalibrator2):
    ...
    def get_batch(self, names):
        ...
        try:
            ...
            log.info(f"Calibrating image {self.image_batcher.image_index} / {self.image_batcher.num_images}")
    ...
    def read_calibration_cache(self):
        ...
        if os.path.exists(self.cache_file):
            with open(self.cache_file, "rb") as f:
                log.info(f"Using calibration cache file: {self.cache_file}")
                return f.read()
    ...
    def write_calibration_cache(self, cache):
        ...
        with open(self.cache_file, "wb") as f:
            log.info(f"Writing calibration cache data to: {self.cache_file}")
            f.write(cache)
