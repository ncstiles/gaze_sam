...
class EngineBuilder:
    ...
    def create_engine(
        ...
        names = [
            "/mask_downscaling/mask_downscaling.1/ReduceMean_1",
            "/mask_downscaling/mask_downscaling.4/ReduceMean_1",
            "/mask_downscaling/mask_downscaling.1/Sub",
            "/mask_downscaling/mask_downscaling.1/Pow",
            "/mask_downscaling/mask_downscaling.1/Add",
            "/mask_downscaling/mask_downscaling.1/Sqrt",
            "/mask_downscaling/mask_downscaling.1/Div",
            "/mask_downscaling/mask_downscaling.1/Mul",
            "/mask_downscaling/mask_downscaling.1/Add_1",
            "/mask_downscaling/mask_downscaling.4/Sub",
            "/mask_downscaling/mask_downscaling.4/Pow",
            "/mask_downscaling/mask_downscaling.4/Add",
            "/mask_downscaling/mask_downscaling.4/Sqrt",
            "/mask_downscaling/mask_downscaling.4/Div",
            "/mask_downscaling/mask_downscaling.4/Mul",
            "/mask_downscaling/mask_downscaling.4/Add_1",
            "/output_upscaling/output_upscaling.1/Sub", 
            "/output_upscaling/output_upscaling.1/Pow", 
            "/output_upscaling/output_upscaling.1/ReduceMean_1", 
            "/output_upscaling/output_upscaling.1/Add", 
            "/output_upscaling/output_upscaling.1/Sqrt", 
            "/output_upscaling/output_upscaling.1/Div", 
            "/output_upscaling/output_upscaling.1/Mul", 
            "/output_upscaling/output_upscaling.1/Add_1"]

        for i in range(self.network.num_layers):
            layer = self.network.get_layer(i)
            if layer.name in names or "norm" in layer.name:
