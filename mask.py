...
def main():
    ...
    parser.add_argument("--output_path", type=str, default="base_imgs/psycho_out_onemask.png")
    ...
    if args.mode == "all":
        ...
        print("total time to segment all masks:", end - start)
    elif args.mode == "point":
        start = time.time()
        args.point = yaml.safe_load(args.point or f"[[{595},{361},{1}]]")
        ...
        print("total time to segment 1 mask:", end - start)
    elif args.mode == "box":
